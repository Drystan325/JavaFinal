...
public class transaction extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        VDate.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        VDate.setText("View By Date");
        VDate.setToolTipText("");
        ...
        VUser.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        VUser.setText("View By User");
        VUser.setToolTipText("");
        ...
        txtfield.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        txtfield.setForeground(new java.awt.Color(255, 255, 255));

        usrf.setBackground(new java.awt.Color(0, 0, 0));
